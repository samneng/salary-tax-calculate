...
const calculatorSchema = z.object({
  ...
  nffsRate: z.number().positive('NSSF rate must be a positive number').optional(),
});
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="p-3 md:p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <InputField
            ...
            type="number"
            step="0.01"
            register={register('netSalary', { valueAsNumber: true })}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <InputField
            ...
            type="number"
            step="0.01"
            register={register('nffsRate', { valueAsNumber: true })}
            error={errors.nffsRate?.message}
        ...
        <div className="border-t border-gray-100 bg-gray-50 p-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500">
              NSSF Deducted: <span className='font-bold text-gray-900'>${result[1].toFixed(2)}</span>
            </p>
